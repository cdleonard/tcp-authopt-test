...
class tcp_authopt_key:
    ...
    def __init__(
        ...
        nosend: bool = False,
        norecv: bool = False,
        send_lifetime_begin: typing.Optional[datetime] = None,
        send_lifetime_end: typing.Optional[datetime] = None,
        recv_lifetime_begin: typing.Optional[datetime] = None,
        recv_lifetime_end: typing.Optional[datetime] = None,
    ):
        self.flags = flags
    ...
    def get_real_flags(self) -> TCP_AUTHOPT_KEY_FLAG:
        ...
        if self.auto_flags:
            ...
            _handle_auto_flag("send_lifetime_begin")
            _handle_auto_flag("send_lifetime_end")
            _handle_auto_flag("recv_lifetime_begin")
            _handle_auto_flag("recv_lifetime_end")
        return result
